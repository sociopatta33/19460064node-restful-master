...
class PedidosController
{
    ...
    static async indexPost(req, res) {
        try {
            ...
            res.status(201)
                .header('Location', `/pedidos/${insertedId}`)
    ...
    static async itemPut(req, res) {
        try {
            ...
            const result = await PedidosModel.reemplazar(id, updatedData);
    ...
    static async itemPatch(req, res) {
        try {
            ...
            const result = await PedidosModel.actualizar(id, updatedFields);
